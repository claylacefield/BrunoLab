function varargout = dendCaPlotFieldsPeaksSEM_110814a(varargin)
% DENDCAPLOTFIELDSPEAKSSEM_110814A MATLAB code for dendCaPlotFieldsPeaksSEM_110814a.fig
%      DENDCAPLOTFIELDSPEAKSSEM_110814A, by itself, creates a new DENDCAPLOTFIELDSPEAKSSEM_110814A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSSEM_110814A returns the handle to a new DENDCAPLOTFIELDSPEAKSSEM_110814A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSSEM_110814A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSSEM_110814A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSSEM_110814A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSSEM_110814A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksSEM_110814a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksSEM_110814a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksSEM_110814a

% Last Modified by GUIDE v2.5 08-Nov-2014 19:59:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksSEM_110814a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksSEM_110814a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksSEM_110814a is made visible.
function dendCaPlotFieldsPeaksSEM_110814a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksSEM_110814a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksSEM_110814a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dendCaPlotFieldsPeaksSEM_110814a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksSEM_110814a_OutputFcn(hObject, eventdata, handles) 

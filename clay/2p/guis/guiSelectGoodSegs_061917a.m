function varargout = guiSelectGoodSegs_061917a(varargin)
% GUISELECTGOODSEGS_061917A MATLAB code for guiSelectGoodSegs_061917a.fig
%      GUISELECTGOODSEGS_061917A, by itself, creates a new GUISELECTGOODSEGS_061917A or raises the existing
%      singleton*.
%
%      H = GUISELECTGOODSEGS_061917A returns the handle to a new GUISELECTGOODSEGS_061917A or the handle to
%      the existing singleton*.
%
%      GUISELECTGOODSEGS_061917A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTGOODSEGS_061917A.M with the given input arguments.
%
%      GUISELECTGOODSEGS_061917A('Property','Value',...) creates a new GUISELECTGOODSEGS_061917A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectGoodSegs_061917a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectGoodSegs_061917a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectGoodSegs_061917a

% Last Modified by GUIDE v2.5 22-Jun-2017 04:28:20
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @guiSelectGoodSegs_061917a_OpeningFcn, ...
    'gui_OutputFcn',  @guiSelectGoodSegs_061917a_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before guiSelectGoodSegs_061917a is made visible.
function guiSelectGoodSegs_061917a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectGoodSegs_061917a (see VARARGIN)

% Choose default command line output for guiSelectGoodSegs_061917a
...
% UIWAIT makes guiSelectGoodSegs_061917a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = guiSelectGoodSegs_061917a_OutputFcn(hObject, eventdata, handles)

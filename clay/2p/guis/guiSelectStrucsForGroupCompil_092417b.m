function varargout = guiSelectStrucsForGroupCompil_092417b(varargin)
% GUISELECTSTRUCSFORGROUPCOMPIL_092417B MATLAB code for guiSelectStrucsForGroupCompil_092417b.fig
%      GUISELECTSTRUCSFORGROUPCOMPIL_092417B, by itself, creates a new GUISELECTSTRUCSFORGROUPCOMPIL_092417B or raises the existing
%      singleton*.
%
%      H = GUISELECTSTRUCSFORGROUPCOMPIL_092417B returns the handle to a new GUISELECTSTRUCSFORGROUPCOMPIL_092417B or the handle to
%      the existing singleton*.
%
%      GUISELECTSTRUCSFORGROUPCOMPIL_092417B('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTSTRUCSFORGROUPCOMPIL_092417B.M with the given input arguments.
%
%      GUISELECTSTRUCSFORGROUPCOMPIL_092417B('Property','Value',...) creates a new GUISELECTSTRUCSFORGROUPCOMPIL_092417B or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectStrucsForGroupCompil_092417b_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectStrucsForGroupCompil_092417b_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectStrucsForGroupCompil_092417b

% Last Modified by GUIDE v2.5 26-Sep-2017 01:07:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @guiSelectStrucsForGroupCompil_092417b_OpeningFcn, ...
                   'gui_OutputFcn',  @guiSelectStrucsForGroupCompil_092417b_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before guiSelectStrucsForGroupCompil_092417b is made visible.
function guiSelectStrucsForGroupCompil_092417b_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectStrucsForGroupCompil_092417b (see VARARGIN)

% Choose default command line output for guiSelectStrucsForGroupCompil_092417b
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes guiSelectStrucsForGroupCompil_092417b wait for user response (see UIRESUME)
...
function varargout = guiSelectStrucsForGroupCompil_092417b_OutputFcn(hObject, eventdata, handles) 

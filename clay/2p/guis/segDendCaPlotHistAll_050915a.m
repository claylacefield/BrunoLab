function varargout = segDendCaPlotHistAll_050915a(varargin)
% SEGDENDCAPLOTHISTALL_050915A MATLAB code for segDendCaPlotHistAll_050915a.fig
%      SEGDENDCAPLOTHISTALL_050915A, by itself, creates a new SEGDENDCAPLOTHISTALL_050915A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_050915A returns the handle to a new SEGDENDCAPLOTHISTALL_050915A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_050915A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_050915A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_050915A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_050915A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_050915a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_050915a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_050915a

% Last Modified by GUIDE v2.5 09-May-2015 16:52:08

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_050915a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_050915a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_050915a is made visible.
function segDendCaPlotHistAll_050915a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_050915a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_050915a
...
% UIWAIT makes segDendCaPlotHistAll_050915a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_050915a_OutputFcn(hObject, eventdata, handles) 
...
% hObject    handle to loadGoodSegButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to saveGoodSegButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

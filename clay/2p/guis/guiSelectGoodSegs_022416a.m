function varargout = guiSelectGoodSegs_022416a(varargin)
% GUISELECTGOODSEGS_022416A MATLAB code for guiSelectGoodSegs_022416a.fig
%      GUISELECTGOODSEGS_022416A, by itself, creates a new GUISELECTGOODSEGS_022416A or raises the existing
%      singleton*.
%
%      H = GUISELECTGOODSEGS_022416A returns the handle to a new GUISELECTGOODSEGS_022416A or the handle to
%      the existing singleton*.
%
%      GUISELECTGOODSEGS_022416A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTGOODSEGS_022416A.M with the given input arguments.
%
%      GUISELECTGOODSEGS_022416A('Property','Value',...) creates a new GUISELECTGOODSEGS_022416A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectGoodSegs_022416a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectGoodSegs_022416a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectGoodSegs_022416a

% Last Modified by GUIDE v2.5 24-Feb-2016 22:05:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @guiSelectGoodSegs_022416a_OpeningFcn, ...
    'gui_OutputFcn',  @guiSelectGoodSegs_022416a_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before guiSelectGoodSegs_022416a is made visible.
function guiSelectGoodSegs_022416a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectGoodSegs_022416a (see VARARGIN)

% Choose default command line output for guiSelectGoodSegs_022416a
...
% UIWAIT makes guiSelectGoodSegs_022416a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = guiSelectGoodSegs_022416a_OutputFcn(hObject, eventdata, handles)

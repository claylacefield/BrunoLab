function varargout = guiSelectStrucsForGroupCompil_092116a(varargin)
% GUISELECTSTRUCSFORGROUPCOMPIL_092116A MATLAB code for guiSelectStrucsForGroupCompil_092116a.fig
%      GUISELECTSTRUCSFORGROUPCOMPIL_092116A, by itself, creates a new GUISELECTSTRUCSFORGROUPCOMPIL_092116A or raises the existing
%      singleton*.
%
%      H = GUISELECTSTRUCSFORGROUPCOMPIL_092116A returns the handle to a new GUISELECTSTRUCSFORGROUPCOMPIL_092116A or the handle to
%      the existing singleton*.
%
%      GUISELECTSTRUCSFORGROUPCOMPIL_092116A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTSTRUCSFORGROUPCOMPIL_092116A.M with the given input arguments.
%
%      GUISELECTSTRUCSFORGROUPCOMPIL_092116A('Property','Value',...) creates a new GUISELECTSTRUCSFORGROUPCOMPIL_092116A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectStrucsForGroupCompil_092116a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectStrucsForGroupCompil_092116a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectStrucsForGroupCompil_092116a

% Last Modified by GUIDE v2.5 25-Sep-2017 00:30:20

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @guiSelectStrucsForGroupCompil_092116a_OpeningFcn, ...
                   'gui_OutputFcn',  @guiSelectStrucsForGroupCompil_092116a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before guiSelectStrucsForGroupCompil_092116a is made visible.
function guiSelectStrucsForGroupCompil_092116a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectStrucsForGroupCompil_092116a (see VARARGIN)

% Choose default command line output for guiSelectStrucsForGroupCompil_092116a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes guiSelectStrucsForGroupCompil_092116a wait for user response (see UIRESUME)
...
function varargout = guiSelectStrucsForGroupCompil_092116a_OutputFcn(hObject, eventdata, handles) 

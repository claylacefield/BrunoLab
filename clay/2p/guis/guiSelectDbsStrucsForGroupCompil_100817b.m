function varargout = guiSelectDbsStrucsForGroupCompil_100817b(varargin)
% GUISELECTDBSSTRUCSFORGROUPCOMPIL_100817B MATLAB code for guiSelectDbsStrucsForGroupCompil_100817b.fig
%      GUISELECTDBSSTRUCSFORGROUPCOMPIL_100817B, by itself, creates a new GUISELECTDBSSTRUCSFORGROUPCOMPIL_100817B or raises the existing
%      singleton*.
%
%      H = GUISELECTDBSSTRUCSFORGROUPCOMPIL_100817B returns the handle to a new GUISELECTDBSSTRUCSFORGROUPCOMPIL_100817B or the handle to
%      the existing singleton*.
%
%      GUISELECTDBSSTRUCSFORGROUPCOMPIL_100817B('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTDBSSTRUCSFORGROUPCOMPIL_100817B.M with the given input arguments.
%
%      GUISELECTDBSSTRUCSFORGROUPCOMPIL_100817B('Property','Value',...) creates a new GUISELECTDBSSTRUCSFORGROUPCOMPIL_100817B or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectDbsStrucsForGroupCompil_100817b_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectDbsStrucsForGroupCompil_100817b_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectDbsStrucsForGroupCompil_100817b

% Last Modified by GUIDE v2.5 09-Oct-2017 02:33:21

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @guiSelectDbsStrucsForGroupCompil_100817b_OpeningFcn, ...
    'gui_OutputFcn',  @guiSelectDbsStrucsForGroupCompil_100817b_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
%% --- Executes just before guiSelectDbsStrucsForGroupCompil_100817b is made visible.
function guiSelectDbsStrucsForGroupCompil_100817b_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectDbsStrucsForGroupCompil_100817b (see VARARGIN)

% Choose default command line output for guiSelectDbsStrucsForGroupCompil_100817b
handles.output = hObject;

% Update handles structure
%guidata(hObject, handles);

% UIWAIT makes guiSelectDbsStrucsForGroupCompil_100817b wait for user response (see UIRESUME)
...
function varargout = guiSelectDbsStrucsForGroupCompil_100817b_OutputFcn(hObject, eventdata, handles)

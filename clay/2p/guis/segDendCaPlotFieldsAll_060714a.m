function varargout = segDendCaPlotFieldsAll_060714a(varargin)
% SEGDENDCAPLOTFIELDSALL_060714A MATLAB code for segDendCaPlotFieldsAll_060714a.fig
%      SEGDENDCAPLOTFIELDSALL_060714A, by itself, creates a new SEGDENDCAPLOTFIELDSALL_060714A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTFIELDSALL_060714A returns the handle to a new SEGDENDCAPLOTFIELDSALL_060714A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTFIELDSALL_060714A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTFIELDSALL_060714A.M with the given input arguments.
%
%      SEGDENDCAPLOTFIELDSALL_060714A('Property','Value',...) creates a new SEGDENDCAPLOTFIELDSALL_060714A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotFieldsAll_060714a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotFieldsAll_060714a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotFieldsAll_060714a

% Last Modified by GUIDE v2.5 07-Jun-2014 16:48:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotFieldsAll_060714a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotFieldsAll_060714a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotFieldsAll_060714a is made visible.
function segDendCaPlotFieldsAll_060714a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotFieldsAll_060714a (see VARARGIN)

% Choose default command line output for segDendCaPlotFieldsAll_060714a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes segDendCaPlotFieldsAll_060714a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotFieldsAll_060714a_OutputFcn(hObject, eventdata, handles) 
...
try
errorbar(handles.behavCaPlot, xAx, 5*mean(caData2b,2), 5*sem2, 'm');
catch
end

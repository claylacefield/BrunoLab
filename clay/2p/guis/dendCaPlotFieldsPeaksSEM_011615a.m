function varargout = dendCaPlotFieldsPeaksSEM_011615a(varargin)
% DENDCAPLOTFIELDSPEAKSSEM_011615A MATLAB code for dendCaPlotFieldsPeaksSEM_011615a.fig
%      DENDCAPLOTFIELDSPEAKSSEM_011615A, by itself, creates a new DENDCAPLOTFIELDSPEAKSSEM_011615A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSSEM_011615A returns the handle to a new DENDCAPLOTFIELDSPEAKSSEM_011615A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSSEM_011615A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSSEM_011615A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSSEM_011615A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSSEM_011615A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksSEM_011615a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksSEM_011615a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksSEM_011615a

% Last Modified by GUIDE v2.5 16-Jan-2015 19:20:02

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksSEM_011615a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksSEM_011615a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksSEM_011615a is made visible.
function dendCaPlotFieldsPeaksSEM_011615a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksSEM_011615a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksSEM_011615a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dendCaPlotFieldsPeaksSEM_011615a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksSEM_011615a_OutputFcn(hObject, eventdata, handles) 

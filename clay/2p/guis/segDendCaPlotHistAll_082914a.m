function varargout = segDendCaPlotHistAll_082914a(varargin)
% SEGDENDCAPLOTHISTALL_082914A MATLAB code for segDendCaPlotHistAll_082914a.fig
%      SEGDENDCAPLOTHISTALL_082914A, by itself, creates a new SEGDENDCAPLOTHISTALL_082914A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_082914A returns the handle to a new SEGDENDCAPLOTHISTALL_082914A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_082914A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_082914A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_082914A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_082914A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_082914a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_082914a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_082914a

% Last Modified by GUIDE v2.5 09-May-2015 16:50:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_082914a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_082914a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_082914a is made visible.
function segDendCaPlotHistAll_082914a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_082914a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_082914a
...
% UIWAIT makes segDendCaPlotHistAll_082914a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_082914a_OutputFcn(hObject, eventdata, handles) 

function varargout = guiSelectGoodSegs_021616a(varargin)
% GUISELECTGOODSEGS_021616A MATLAB code for guiSelectGoodSegs_021616a.fig
%      GUISELECTGOODSEGS_021616A, by itself, creates a new GUISELECTGOODSEGS_021616A or raises the existing
%      singleton*.
%
%      H = GUISELECTGOODSEGS_021616A returns the handle to a new GUISELECTGOODSEGS_021616A or the handle to
%      the existing singleton*.
%
%      GUISELECTGOODSEGS_021616A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTGOODSEGS_021616A.M with the given input arguments.
%
%      GUISELECTGOODSEGS_021616A('Property','Value',...) creates a new GUISELECTGOODSEGS_021616A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectGoodSegs_021616a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectGoodSegs_021616a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectGoodSegs_021616a

% Last Modified by GUIDE v2.5 17-Feb-2016 02:15:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @guiSelectGoodSegs_021616a_OpeningFcn, ...
    'gui_OutputFcn',  @guiSelectGoodSegs_021616a_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before guiSelectGoodSegs_021616a is made visible.
function guiSelectGoodSegs_021616a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectGoodSegs_021616a (see VARARGIN)

% Choose default command line output for guiSelectGoodSegs_021616a
...
% UIWAIT makes guiSelectGoodSegs_021616a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = guiSelectGoodSegs_021616a_OutputFcn(hObject, eventdata, handles)
...
r4 = xcorr(cax, whiskerData', 1000, 'coeff');

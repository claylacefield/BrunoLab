function varargout = segDendCaPlotHistAll_110615a(varargin)
% SEGDENDCAPLOTHISTALL_110615A MATLAB code for segDendCaPlotHistAll_110615a.fig
%      SEGDENDCAPLOTHISTALL_110615A, by itself, creates a new SEGDENDCAPLOTHISTALL_110615A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_110615A returns the handle to a new SEGDENDCAPLOTHISTALL_110615A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_110615A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_110615A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_110615A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_110615A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_110615a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_110615a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_110615a

% Last Modified by GUIDE v2.5 06-Nov-2015 18:38:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_110615a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_110615a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_110615a is made visible.
function segDendCaPlotHistAll_110615a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_110615a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_110615a
...
% UIWAIT makes segDendCaPlotHistAll_110615a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_110615a_OutputFcn(hObject, eventdata, handles) 

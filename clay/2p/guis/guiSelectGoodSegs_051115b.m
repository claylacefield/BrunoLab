function varargout = guiSelectGoodSegs_051115b(varargin)
% GUISELECTGOODSEGS_051115B MATLAB code for guiSelectGoodSegs_051115b.fig
%      GUISELECTGOODSEGS_051115B, by itself, creates a new GUISELECTGOODSEGS_051115B or raises the existing
%      singleton*.
%
%      H = GUISELECTGOODSEGS_051115B returns the handle to a new GUISELECTGOODSEGS_051115B or the handle to
%      the existing singleton*.
%
%      GUISELECTGOODSEGS_051115B('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTGOODSEGS_051115B.M with the given input arguments.
%
%      GUISELECTGOODSEGS_051115B('Property','Value',...) creates a new GUISELECTGOODSEGS_051115B or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectGoodSegs_051115b_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectGoodSegs_051115b_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectGoodSegs_051115b

% Last Modified by GUIDE v2.5 11-May-2015 21:23:42

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @guiSelectGoodSegs_051115b_OpeningFcn, ...
                   'gui_OutputFcn',  @guiSelectGoodSegs_051115b_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before guiSelectGoodSegs_051115b is made visible.
function guiSelectGoodSegs_051115b_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectGoodSegs_051115b (see VARARGIN)

% Choose default command line output for guiSelectGoodSegs_051115b
...
% UIWAIT makes guiSelectGoodSegs_051115b wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = guiSelectGoodSegs_051115b_OutputFcn(hObject, eventdata, handles) 
...
save([filename(1:14) '_goodSeg_' goodSegTag filename((end-15):end)], 'goodSeg');
save([filename(1:14) '_greatSeg_' goodSegTag filename((end-15):end)], 'greatSeg');
...
% hObject    handle to addOkSegButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to remOkSegButton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

function varargout = segDendCaPlotFields_012214a(varargin)
% SEGDENDCAPLOTFIELDS_012214A MATLAB code for segDendCaPlotFields_012214a.fig
%      SEGDENDCAPLOTFIELDS_012214A, by itself, creates a new SEGDENDCAPLOTFIELDS_012214A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTFIELDS_012214A returns the handle to a new SEGDENDCAPLOTFIELDS_012214A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTFIELDS_012214A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTFIELDS_012214A.M with the given input arguments.
%
%      SEGDENDCAPLOTFIELDS_012214A('Property','Value',...) creates a new SEGDENDCAPLOTFIELDS_012214A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotFields_012214a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotFields_012214a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotFields_012214a

% Last Modified by GUIDE v2.5 22-Jan-2014 15:36:03

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @segDendCaPlotFields_012214a_OpeningFcn, ...
    'gui_OutputFcn',  @segDendCaPlotFields_012214a_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotFields_012214a is made visible.
function segDendCaPlotFields_012214a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotFields_012214a (see VARARGIN)

% Choose default command line output for segDendCaPlotFields_012214a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes segDendCaPlotFields_012214a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotFields_012214a_OutputFcn(hObject, eventdata, handles)
...
% or plot individual traces
maxVal = 1;

plot(handles.behavCaPlot, xAx, squeeze(caData1(:,segNum,:)), 'b'); % ylim([-0.05 0.3]);
hold(handles.behavCaPlot);
plot(handles.behavCaPlot, xAx, squeeze(caData2(:,segNum,:)), 'r'); 
...
% save some stuff to handles struc
A = handles.A;
C = handles.C;
d1 = handles.d1;
d2 = handles.d2;

function varargout = guiSelectDbsStrucsForGroupCompil_092517a(varargin)
% GUISELECTDBSSTRUCSFORGROUPCOMPIL_092517A MATLAB code for guiSelectDbsStrucsForGroupCompil_092517a.fig
%      GUISELECTDBSSTRUCSFORGROUPCOMPIL_092517A, by itself, creates a new GUISELECTDBSSTRUCSFORGROUPCOMPIL_092517A or raises the existing
%      singleton*.
%
%      H = GUISELECTDBSSTRUCSFORGROUPCOMPIL_092517A returns the handle to a new GUISELECTDBSSTRUCSFORGROUPCOMPIL_092517A or the handle to
%      the existing singleton*.
%
%      GUISELECTDBSSTRUCSFORGROUPCOMPIL_092517A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTDBSSTRUCSFORGROUPCOMPIL_092517A.M with the given input arguments.
%
%      GUISELECTDBSSTRUCSFORGROUPCOMPIL_092517A('Property','Value',...) creates a new GUISELECTDBSSTRUCSFORGROUPCOMPIL_092517A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectDbsStrucsForGroupCompil_092517a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectDbsStrucsForGroupCompil_092517a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectDbsStrucsForGroupCompil_092517a

% Last Modified by GUIDE v2.5 26-Sep-2017 03:46:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @guiSelectDbsStrucsForGroupCompil_092517a_OpeningFcn, ...
    'gui_OutputFcn',  @guiSelectDbsStrucsForGroupCompil_092517a_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
%% --- Executes just before guiSelectDbsStrucsForGroupCompil_092517a is made visible.
function guiSelectDbsStrucsForGroupCompil_092517a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectDbsStrucsForGroupCompil_092517a (see VARARGIN)

% Choose default command line output for guiSelectDbsStrucsForGroupCompil_092517a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes guiSelectDbsStrucsForGroupCompil_092517a wait for user response (see UIRESUME)
...
function varargout = guiSelectDbsStrucsForGroupCompil_092517a_OutputFcn(hObject, eventdata, handles)

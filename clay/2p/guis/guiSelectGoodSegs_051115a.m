function varargout = guiSelectGoodSegs_051115a(varargin)
% GUISELECTGOODSEGS_051115A MATLAB code for guiSelectGoodSegs_051115a.fig
%      GUISELECTGOODSEGS_051115A, by itself, creates a new GUISELECTGOODSEGS_051115A or raises the existing
%      singleton*.
%
%      H = GUISELECTGOODSEGS_051115A returns the handle to a new GUISELECTGOODSEGS_051115A or the handle to
%      the existing singleton*.
%
%      GUISELECTGOODSEGS_051115A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTGOODSEGS_051115A.M with the given input arguments.
%
%      GUISELECTGOODSEGS_051115A('Property','Value',...) creates a new GUISELECTGOODSEGS_051115A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectGoodSegs_051115a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectGoodSegs_051115a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectGoodSegs_051115a

% Last Modified by GUIDE v2.5 11-May-2015 19:40:26

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @guiSelectGoodSegs_051115a_OpeningFcn, ...
                   'gui_OutputFcn',  @guiSelectGoodSegs_051115a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before guiSelectGoodSegs_051115a is made visible.
function guiSelectGoodSegs_051115a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectGoodSegs_051115a (see VARARGIN)

% Choose default command line output for guiSelectGoodSegs_051115a
...
% UIWAIT makes guiSelectGoodSegs_051115a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = guiSelectGoodSegs_051115a_OutputFcn(hObject, eventdata, handles) 
...
% hObject    handle to goodSegTagTxt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

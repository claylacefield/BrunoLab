function varargout = dendCaPlotFieldsPeaksTimecourse_122914a(varargin)
% DENDCAPLOTFIELDSPEAKSTIMECOURSE_122914A MATLAB code for dendCaPlotFieldsPeaksTimecourse_122914a.fig
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_122914A, by itself, creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_122914A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSTIMECOURSE_122914A returns the handle to a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_122914A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_122914A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSTIMECOURSE_122914A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_122914A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_122914A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksTimecourse_122914a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksTimecourse_122914a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksTimecourse_122914a

% Last Modified by GUIDE v2.5 29-Dec-2014 20:45:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksTimecourse_122914a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksTimecourse_122914a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksTimecourse_122914a is made visible.
function dendCaPlotFieldsPeaksTimecourse_122914a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksTimecourse_122914a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksTimecourse_122914a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dendCaPlotFieldsPeaksTimecourse_122914a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksTimecourse_122914a_OutputFcn(hObject, eventdata, handles) 

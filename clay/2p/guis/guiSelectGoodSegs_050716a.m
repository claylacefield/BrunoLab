function varargout = guiSelectGoodSegs_050716a(varargin)
% GUISELECTGOODSEGS_050716A MATLAB code for guiSelectGoodSegs_050716a.fig
%      GUISELECTGOODSEGS_050716A, by itself, creates a new GUISELECTGOODSEGS_050716A or raises the existing
%      singleton*.
%
%      H = GUISELECTGOODSEGS_050716A returns the handle to a new GUISELECTGOODSEGS_050716A or the handle to
%      the existing singleton*.
%
%      GUISELECTGOODSEGS_050716A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTGOODSEGS_050716A.M with the given input arguments.
%
%      GUISELECTGOODSEGS_050716A('Property','Value',...) creates a new GUISELECTGOODSEGS_050716A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectGoodSegs_050716a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectGoodSegs_050716a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectGoodSegs_050716a

% Last Modified by GUIDE v2.5 08-May-2016 23:18:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @guiSelectGoodSegs_050716a_OpeningFcn, ...
    'gui_OutputFcn',  @guiSelectGoodSegs_050716a_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before guiSelectGoodSegs_050716a is made visible.
function guiSelectGoodSegs_050716a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectGoodSegs_050716a (see VARARGIN)

% Choose default command line output for guiSelectGoodSegs_050716a
...
% UIWAIT makes guiSelectGoodSegs_050716a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = guiSelectGoodSegs_050716a_OutputFcn(hObject, eventdata, handles)

function varargout = guiSelectGoodSegs_051215a(varargin)
% GUISELECTGOODSEGS_051215A MATLAB code for guiSelectGoodSegs_051215a.fig
%      GUISELECTGOODSEGS_051215A, by itself, creates a new GUISELECTGOODSEGS_051215A or raises the existing
%      singleton*.
%
%      H = GUISELECTGOODSEGS_051215A returns the handle to a new GUISELECTGOODSEGS_051215A or the handle to
%      the existing singleton*.
%
%      GUISELECTGOODSEGS_051215A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUISELECTGOODSEGS_051215A.M with the given input arguments.
%
%      GUISELECTGOODSEGS_051215A('Property','Value',...) creates a new GUISELECTGOODSEGS_051215A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guiSelectGoodSegs_051215a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guiSelectGoodSegs_051215a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guiSelectGoodSegs_051215a

% Last Modified by GUIDE v2.5 12-May-2015 12:31:12

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @guiSelectGoodSegs_051215a_OpeningFcn, ...
                   'gui_OutputFcn',  @guiSelectGoodSegs_051215a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before guiSelectGoodSegs_051215a is made visible.
function guiSelectGoodSegs_051215a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guiSelectGoodSegs_051215a (see VARARGIN)

% Choose default command line output for guiSelectGoodSegs_051215a
...
% UIWAIT makes guiSelectGoodSegs_051215a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = guiSelectGoodSegs_051215a_OutputFcn(hObject, eventdata, handles) 

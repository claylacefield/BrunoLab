function varargout = segDendCaPlotHistAll_070814a(varargin)
% SEGDENDCAPLOTHISTALL_070814A MATLAB code for segDendCaPlotHistAll_070814a.fig
%      SEGDENDCAPLOTHISTALL_070814A, by itself, creates a new SEGDENDCAPLOTHISTALL_070814A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_070814A returns the handle to a new SEGDENDCAPLOTHISTALL_070814A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_070814A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_070814A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_070814A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_070814A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_070814a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_070814a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_070814a

% Last Modified by GUIDE v2.5 08-Jul-2014 21:06:34

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_070814a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_070814a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_070814a is made visible.
function segDendCaPlotHistAll_070814a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_070814a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_070814a
...
% UIWAIT makes segDendCaPlotHistAll_070814a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_070814a_OutputFcn(hObject, eventdata, handles) 
...
if checkbox3state == 1
    ...
    axes(handles.axes4);
    plot(trialCaData1); xlim([1 33]); ylim([-0.1 0.5]);

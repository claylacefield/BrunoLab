function varargout = dendCaPlotEventHist_072414a(varargin)
% DENDCAPLOTEVENTHIST_072414A MATLAB code for dendCaPlotEventHist_072414a.fig
%      DENDCAPLOTEVENTHIST_072414A, by itself, creates a new DENDCAPLOTEVENTHIST_072414A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTEVENTHIST_072414A returns the handle to a new DENDCAPLOTEVENTHIST_072414A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTEVENTHIST_072414A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTEVENTHIST_072414A.M with the given input arguments.
%
%      DENDCAPLOTEVENTHIST_072414A('Property','Value',...) creates a new DENDCAPLOTEVENTHIST_072414A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotEventHist_072414a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotEventHist_072414a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotEventHist_072414a

% Last Modified by GUIDE v2.5 24-Jul-2014 16:43:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotEventHist_072414a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotEventHist_072414a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dendCaPlotEventHist_072414a is made visible.
function dendCaPlotEventHist_072414a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotEventHist_072414a (see VARARGIN)

% Choose default command line output for dendCaPlotEventHist_072414a
...
% UIWAIT makes dendCaPlotEventHist_072414a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotEventHist_072414a_OutputFcn(hObject, eventdata, handles) 

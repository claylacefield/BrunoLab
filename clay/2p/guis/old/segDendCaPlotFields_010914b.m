function varargout = segDendCaPlotFields_010914b(varargin)
% SEGDENDCAPLOTFIELDS_010914B MATLAB code for segDendCaPlotFields_010914b.fig
%      SEGDENDCAPLOTFIELDS_010914B, by itself, creates a new SEGDENDCAPLOTFIELDS_010914B or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTFIELDS_010914B returns the handle to a new SEGDENDCAPLOTFIELDS_010914B or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTFIELDS_010914B('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTFIELDS_010914B.M with the given input arguments.
%
%      SEGDENDCAPLOTFIELDS_010914B('Property','Value',...) creates a new SEGDENDCAPLOTFIELDS_010914B or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotFields_010914b_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotFields_010914b_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotFields_010914b

% Last Modified by GUIDE v2.5 09-Jan-2014 18:51:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotFields_010914b_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotFields_010914b_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotFields_010914b is made visible.
function segDendCaPlotFields_010914b_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotFields_010914b (see VARARGIN)

% Choose default command line output for segDendCaPlotFields_010914b
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes segDendCaPlotFields_010914b wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotFields_010914b_OutputFcn(hObject, eventdata, handles) 

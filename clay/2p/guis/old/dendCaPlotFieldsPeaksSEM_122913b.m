function varargout = dendCaPlotFieldsPeaksSEM_122913b(varargin)
% DENDCAPLOTFIELDSPEAKSSEM_122913B MATLAB code for dendCaPlotFieldsPeaksSEM_122913b.fig
%      DENDCAPLOTFIELDSPEAKSSEM_122913B, by itself, creates a new DENDCAPLOTFIELDSPEAKSSEM_122913B or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSSEM_122913B returns the handle to a new DENDCAPLOTFIELDSPEAKSSEM_122913B or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSSEM_122913B('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSSEM_122913B.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSSEM_122913B('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSSEM_122913B or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksSEM_122913b_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksSEM_122913b_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksSEM_122913b

% Last Modified by GUIDE v2.5 29-Dec-2013 19:02:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksSEM_122913b_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksSEM_122913b_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksSEM_122913b is made visible.
function dendCaPlotFieldsPeaksSEM_122913b_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksSEM_122913b (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksSEM_122913b
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dendCaPlotFieldsPeaksSEM_122913b wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksSEM_122913b_OutputFcn(hObject, eventdata, handles) 

function varargout = dendCaPlotFieldsPeaksTimecourse_071714a(varargin)
% DENDCAPLOTFIELDSPEAKSTIMECOURSE_071714A MATLAB code for dendCaPlotFieldsPeaksTimecourse_071714a.fig
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_071714A, by itself, creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_071714A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSTIMECOURSE_071714A returns the handle to a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_071714A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_071714A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSTIMECOURSE_071714A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_071714A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_071714A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksTimecourse_071714a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksTimecourse_071714a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksTimecourse_071714a

% Last Modified by GUIDE v2.5 17-Jul-2014 17:19:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksTimecourse_071714a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksTimecourse_071714a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksTimecourse_071714a is made visible.
function dendCaPlotFieldsPeaksTimecourse_071714a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksTimecourse_071714a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksTimecourse_071714a
...
% UIWAIT makes dendCaPlotFieldsPeaksTimecourse_071714a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksTimecourse_071714a_OutputFcn(hObject, eventdata, handles) 
...
caData1b = caData1(:,1:fileLim);
caData2b = caData2(:,1:fileLim);
...
%if handles.checkbox1state ~= 0
plot(handles.behavCaPlot, xAx, caData1b, 'b');  xlim([-2 6]); hold(handles.behavCaPlot);
...
errorbar(handles.behavCaPlot, xAx, mean(caData2b,2), sem2, 'm'); 
errorbar(handles.behavCaPlot, xAx, mean(caData1b,2), sem1, 'c');

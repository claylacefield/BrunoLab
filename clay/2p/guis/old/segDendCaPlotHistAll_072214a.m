function varargout = segDendCaPlotHistAll_072214a(varargin)
% SEGDENDCAPLOTHISTALL_072214A MATLAB code for segDendCaPlotHistAll_072214a.fig
%      SEGDENDCAPLOTHISTALL_072214A, by itself, creates a new SEGDENDCAPLOTHISTALL_072214A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_072214A returns the handle to a new SEGDENDCAPLOTHISTALL_072214A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_072214A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_072214A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_072214A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_072214A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_072214a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_072214a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_072214a

% Last Modified by GUIDE v2.5 22-Jul-2014 18:08:21

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_072214a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_072214a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_072214a is made visible.
function segDendCaPlotHistAll_072214a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_072214a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_072214a
...
% UIWAIT makes segDendCaPlotHistAll_072214a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_072214a_OutputFcn(hObject, eventdata, handles) 
...
if checkbox1state == 1
    try
        ...
        hold on;
        errorbar(handles.behavCaPlot, xAx, 5*mean(frDataField1,2), 5*semf1, 'g');
    catch
    end
    try
        errorbar(handles.behavCaPlot, xAx, 5*mean(caData2b,2), 5*sem2, 'y');
        errorbar(handles.behavCaPlot, xAx, 5*mean(frDataField2,2), 5*semf2, 'm');
    catch
    end
    hold off;
end

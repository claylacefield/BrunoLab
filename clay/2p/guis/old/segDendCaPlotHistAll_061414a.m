function varargout = segDendCaPlotHistAll_061414a(varargin)
% SEGDENDCAPLOTHISTALL_061414A MATLAB code for segDendCaPlotHistAll_061414a.fig
%      SEGDENDCAPLOTHISTALL_061414A, by itself, creates a new SEGDENDCAPLOTHISTALL_061414A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_061414A returns the handle to a new SEGDENDCAPLOTHISTALL_061414A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_061414A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_061414A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_061414A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_061414A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_061414a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_061414a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_061414a

% Last Modified by GUIDE v2.5 15-Jun-2014 01:00:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_061414a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_061414a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_061414a is made visible.
function segDendCaPlotHistAll_061414a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_061414a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_061414a
...
% UIWAIT makes segDendCaPlotHistAll_061414a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_061414a_OutputFcn(hObject, eventdata, handles) 

function varargout = segDendCaPlotHistAll_081414a(varargin)
% SEGDENDCAPLOTHISTALL_081414A MATLAB code for segDendCaPlotHistAll_081414a.fig
%      SEGDENDCAPLOTHISTALL_081414A, by itself, creates a new SEGDENDCAPLOTHISTALL_081414A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_081414A returns the handle to a new SEGDENDCAPLOTHISTALL_081414A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_081414A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_081414A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_081414A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_081414A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_081414a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_081414a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_081414a

% Last Modified by GUIDE v2.5 14-Aug-2014 21:36:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_081414a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_081414a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_081414a is made visible.
function segDendCaPlotHistAll_081414a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_081414a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_081414a
...
% UIWAIT makes segDendCaPlotHistAll_081414a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_081414a_OutputFcn(hObject, eventdata, handles) 

function varargout = segDendCaPlotHistAll_060914b(varargin)
% SEGDENDCAPLOTHISTALL_060914B MATLAB code for segDendCaPlotHistAll_060914b.fig
%      SEGDENDCAPLOTHISTALL_060914B, by itself, creates a new SEGDENDCAPLOTHISTALL_060914B or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_060914B returns the handle to a new SEGDENDCAPLOTHISTALL_060914B or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_060914B('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_060914B.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_060914B('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_060914B or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_060914b_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_060914b_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_060914b

% Last Modified by GUIDE v2.5 09-Jun-2014 19:31:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_060914b_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_060914b_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_060914b is made visible.
function segDendCaPlotHistAll_060914b_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_060914b (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_060914b
...
% UIWAIT makes segDendCaPlotHistAll_060914b wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_060914b_OutputFcn(hObject, eventdata, handles) 

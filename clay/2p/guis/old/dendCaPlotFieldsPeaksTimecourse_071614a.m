function varargout = dendCaPlotFieldsPeaksTimecourse_071614a(varargin)
% DENDCAPLOTFIELDSPEAKSTIMECOURSE_071614A MATLAB code for dendCaPlotFieldsPeaksTimecourse_071614a.fig
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_071614A, by itself, creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_071614A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSTIMECOURSE_071614A returns the handle to a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_071614A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_071614A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSTIMECOURSE_071614A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_071614A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_071614A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksTimecourse_071614a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksTimecourse_071614a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksTimecourse_071614a

% Last Modified by GUIDE v2.5 17-Jul-2014 17:13:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksTimecourse_071614a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksTimecourse_071614a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksTimecourse_071614a is made visible.
function dendCaPlotFieldsPeaksTimecourse_071614a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksTimecourse_071614a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksTimecourse_071614a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dendCaPlotFieldsPeaksTimecourse_071614a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksTimecourse_071614a_OutputFcn(hObject, eventdata, handles) 
...
if handles.checkbox1state == 1
plot(handles.behavCaPlot, xAx, caData1b, 'b');  

function varargout = segDendCaPlotHistAll_080514a(varargin)
% SEGDENDCAPLOTHISTALL_080514A MATLAB code for segDendCaPlotHistAll_080514a.fig
%      SEGDENDCAPLOTHISTALL_080514A, by itself, creates a new SEGDENDCAPLOTHISTALL_080514A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_080514A returns the handle to a new SEGDENDCAPLOTHISTALL_080514A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_080514A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_080514A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_080514A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_080514A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_080514a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_080514a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_080514a

% Last Modified by GUIDE v2.5 06-Aug-2014 15:47:08

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_080514a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_080514a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_080514a is made visible.
function segDendCaPlotHistAll_080514a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_080514a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_080514a
...
% UIWAIT makes segDendCaPlotHistAll_080514a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_080514a_OutputFcn(hObject, eventdata, handles) 

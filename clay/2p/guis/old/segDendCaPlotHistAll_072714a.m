function varargout = segDendCaPlotHistAll_072714a(varargin)
% SEGDENDCAPLOTHISTALL_072714A MATLAB code for segDendCaPlotHistAll_072714a.fig
%      SEGDENDCAPLOTHISTALL_072714A, by itself, creates a new SEGDENDCAPLOTHISTALL_072714A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_072714A returns the handle to a new SEGDENDCAPLOTHISTALL_072714A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_072714A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_072714A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_072714A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_072714A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_072714a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_072714a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_072714a

% Last Modified by GUIDE v2.5 28-Jul-2014 00:52:26

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_072714a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_072714a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_072714a is made visible.
function segDendCaPlotHistAll_072714a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_072714a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_072714a
...
% UIWAIT makes segDendCaPlotHistAll_072714a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_072714a_OutputFcn(hObject, eventdata, handles) 

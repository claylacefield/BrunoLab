function varargout = dendCaPlotFieldsPeaksSEM_122913a(varargin)
% DENDCAPLOTFIELDSPEAKSSEM_122913A MATLAB code for dendCaPlotFieldsPeaksSEM_122913a.fig
%      DENDCAPLOTFIELDSPEAKSSEM_122913A, by itself, creates a new DENDCAPLOTFIELDSPEAKSSEM_122913A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSSEM_122913A returns the handle to a new DENDCAPLOTFIELDSPEAKSSEM_122913A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSSEM_122913A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSSEM_122913A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSSEM_122913A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSSEM_122913A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksSEM_122913a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksSEM_122913a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksSEM_122913a

% Last Modified by GUIDE v2.5 29-Dec-2013 18:38:37

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksSEM_122913a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksSEM_122913a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksSEM_122913a is made visible.
function dendCaPlotFieldsPeaksSEM_122913a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksSEM_122913a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksSEM_122913a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dendCaPlotFieldsPeaksSEM_122913a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksSEM_122913a_OutputFcn(hObject, eventdata, handles) 
...
save(FileName, 'field1', 'field2', 'caData1', 'caData2', 'caPeakVal1', 'caPeakInd1', 'caPeakVal2', 'caPeakInd2');

function varargout = segDendCaPlotHistAll_060914a(varargin)
% SEGDENDCAPLOTHISTALL_060914A MATLAB code for segDendCaPlotHistAll_060914a.fig
%      SEGDENDCAPLOTHISTALL_060914A, by itself, creates a new SEGDENDCAPLOTHISTALL_060914A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_060914A returns the handle to a new SEGDENDCAPLOTHISTALL_060914A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_060914A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_060914A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_060914A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_060914A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_060914a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_060914a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_060914a

% Last Modified by GUIDE v2.5 09-Jun-2014 16:41:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_060914a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_060914a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_060914a is made visible.
function segDendCaPlotHistAll_060914a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_060914a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_060914a
...
% UIWAIT makes segDendCaPlotHistAll_060914a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_060914a_OutputFcn(hObject, eventdata, handles) 

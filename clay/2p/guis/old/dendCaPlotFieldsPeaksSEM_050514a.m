function varargout = dendCaPlotFieldsPeaksSEM_050514a(varargin)
% DENDCAPLOTFIELDSPEAKSSEM_050514A MATLAB code for dendCaPlotFieldsPeaksSEM_050514a.fig
%      DENDCAPLOTFIELDSPEAKSSEM_050514A, by itself, creates a new DENDCAPLOTFIELDSPEAKSSEM_050514A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSSEM_050514A returns the handle to a new DENDCAPLOTFIELDSPEAKSSEM_050514A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSSEM_050514A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSSEM_050514A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSSEM_050514A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSSEM_050514A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksSEM_050514a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksSEM_050514a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksSEM_050514a

% Last Modified by GUIDE v2.5 06-May-2014 01:11:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksSEM_050514a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksSEM_050514a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksSEM_050514a is made visible.
function dendCaPlotFieldsPeaksSEM_050514a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksSEM_050514a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksSEM_050514a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dendCaPlotFieldsPeaksSEM_050514a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksSEM_050514a_OutputFcn(hObject, eventdata, handles) 

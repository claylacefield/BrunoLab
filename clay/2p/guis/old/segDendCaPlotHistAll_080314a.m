function varargout = segDendCaPlotHistAll_080314a(varargin)
% SEGDENDCAPLOTHISTALL_080314A MATLAB code for segDendCaPlotHistAll_080314a.fig
%      SEGDENDCAPLOTHISTALL_080314A, by itself, creates a new SEGDENDCAPLOTHISTALL_080314A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_080314A returns the handle to a new SEGDENDCAPLOTHISTALL_080314A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_080314A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_080314A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_080314A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_080314A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_080314a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_080314a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_080314a

% Last Modified by GUIDE v2.5 03-Aug-2014 12:12:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_080314a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_080314a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_080314a is made visible.
function segDendCaPlotHistAll_080314a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_080314a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_080314a
...
% UIWAIT makes segDendCaPlotHistAll_080314a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_080314a_OutputFcn(hObject, eventdata, handles) 

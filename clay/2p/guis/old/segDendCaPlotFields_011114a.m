function varargout = segDendCaPlotFields_011114a(varargin)
% SEGDENDCAPLOTFIELDS_011114A MATLAB code for segDendCaPlotFields_011114a.fig
%      SEGDENDCAPLOTFIELDS_011114A, by itself, creates a new SEGDENDCAPLOTFIELDS_011114A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTFIELDS_011114A returns the handle to a new SEGDENDCAPLOTFIELDS_011114A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTFIELDS_011114A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTFIELDS_011114A.M with the given input arguments.
%
%      SEGDENDCAPLOTFIELDS_011114A('Property','Value',...) creates a new SEGDENDCAPLOTFIELDS_011114A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotFields_011114a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotFields_011114a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotFields_011114a

% Last Modified by GUIDE v2.5 11-Jan-2014 18:41:12

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @segDendCaPlotFields_011114a_OpeningFcn, ...
    'gui_OutputFcn',  @segDendCaPlotFields_011114a_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotFields_011114a is made visible.
function segDendCaPlotFields_011114a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotFields_011114a (see VARARGIN)

% Choose default command line output for segDendCaPlotFields_011114a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes segDendCaPlotFields_011114a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotFields_011114a_OutputFcn(hObject, eventdata, handles)

function varargout = segSomaCaPlotFieldsSEM_052414a(varargin)
% SEGSOMACAPLOTFIELDSSEM_052414A MATLAB code for segSomaCaPlotFieldsSEM_052414a.fig
%      SEGSOMACAPLOTFIELDSSEM_052414A, by itself, creates a new SEGSOMACAPLOTFIELDSSEM_052414A or raises the existing
%      singleton*.
%
%      H = SEGSOMACAPLOTFIELDSSEM_052414A returns the handle to a new SEGSOMACAPLOTFIELDSSEM_052414A or the handle to
%      the existing singleton*.
%
%      SEGSOMACAPLOTFIELDSSEM_052414A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGSOMACAPLOTFIELDSSEM_052414A.M with the given input arguments.
%
%      SEGSOMACAPLOTFIELDSSEM_052414A('Property','Value',...) creates a new SEGSOMACAPLOTFIELDSSEM_052414A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segSomaCaPlotFieldsSEM_052414a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segSomaCaPlotFieldsSEM_052414a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segSomaCaPlotFieldsSEM_052414a

% Last Modified by GUIDE v2.5 24-May-2014 18:49:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segSomaCaPlotFieldsSEM_052414a_OpeningFcn, ...
                   'gui_OutputFcn',  @segSomaCaPlotFieldsSEM_052414a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segSomaCaPlotFieldsSEM_052414a is made visible.
function segSomaCaPlotFieldsSEM_052414a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segSomaCaPlotFieldsSEM_052414a (see VARARGIN)

% Choose default command line output for segSomaCaPlotFieldsSEM_052414a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes segSomaCaPlotFieldsSEM_052414a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segSomaCaPlotFieldsSEM_052414a_OutputFcn(hObject, eventdata, handles) 

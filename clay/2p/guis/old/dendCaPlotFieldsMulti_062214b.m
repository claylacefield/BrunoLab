function varargout = dendCaPlotFieldsMulti_062214b(varargin)
% DENDCAPLOTFIELDSMULTI_062214B MATLAB code for dendCaPlotFieldsMulti_062214b.fig
%      DENDCAPLOTFIELDSMULTI_062214B, by itself, creates a new DENDCAPLOTFIELDSMULTI_062214B or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSMULTI_062214B returns the handle to a new DENDCAPLOTFIELDSMULTI_062214B or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSMULTI_062214B('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSMULTI_062214B.M with the given input arguments.
%
%      DENDCAPLOTFIELDSMULTI_062214B('Property','Value',...) creates a new DENDCAPLOTFIELDSMULTI_062214B or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsMulti_062214b_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsMulti_062214b_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsMulti_062214b

% Last Modified by GUIDE v2.5 23-Jun-2014 01:26:45

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsMulti_062214b_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsMulti_062214b_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsMulti_062214b is made visible.
function dendCaPlotFieldsMulti_062214b_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsMulti_062214b (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsMulti_062214b
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dendCaPlotFieldsMulti_062214b wait for user response (see UIRESUME)
...
function varargout = dendCaPlotFieldsMulti_062214b_OutputFcn(hObject, eventdata, handles) 

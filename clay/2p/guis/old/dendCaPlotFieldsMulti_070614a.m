function varargout = dendCaPlotFieldsMulti_070614a(varargin)
% DENDCAPLOTFIELDSMULTI_070614A MATLAB code for dendCaPlotFieldsMulti_070614a.fig
%      DENDCAPLOTFIELDSMULTI_070614A, by itself, creates a new DENDCAPLOTFIELDSMULTI_070614A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSMULTI_070614A returns the handle to a new DENDCAPLOTFIELDSMULTI_070614A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSMULTI_070614A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSMULTI_070614A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSMULTI_070614A('Property','Value',...) creates a new DENDCAPLOTFIELDSMULTI_070614A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsMulti_070614a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsMulti_070614a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsMulti_070614a

% Last Modified by GUIDE v2.5 08-Jul-2014 11:50:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsMulti_070614a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsMulti_070614a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsMulti_070614a is made visible.
function dendCaPlotFieldsMulti_070614a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsMulti_070614a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsMulti_070614a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dendCaPlotFieldsMulti_070614a wait for user response (see UIRESUME)
...
function varargout = dendCaPlotFieldsMulti_070614a_OutputFcn(hObject, eventdata, handles) 
...
s = load([pathname '/' filename]);   % load in data structure (NOTE: will be one field deep, due to "load" func)
sField = fieldnames(s);
dendriteBehavStruc2 = s.(sField{1}); % dendriteBehavStruc;

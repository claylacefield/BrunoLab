function varargout = dendCaPlotFieldsPeaksTimecourse_070714a(varargin)
% DENDCAPLOTFIELDSPEAKSTIMECOURSE_070714A MATLAB code for dendCaPlotFieldsPeaksTimecourse_070714a.fig
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_070714A, by itself, creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_070714A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSTIMECOURSE_070714A returns the handle to a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_070714A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_070714A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSTIMECOURSE_070714A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_070714A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_070714A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksTimecourse_070714a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksTimecourse_070714a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksTimecourse_070714a

% Last Modified by GUIDE v2.5 07-Jul-2014 18:15:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksTimecourse_070714a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksTimecourse_070714a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksTimecourse_070714a is made visible.
function dendCaPlotFieldsPeaksTimecourse_070714a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksTimecourse_070714a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksTimecourse_070714a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes dendCaPlotFieldsPeaksTimecourse_070714a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksTimecourse_070714a_OutputFcn(hObject, eventdata, handles) 

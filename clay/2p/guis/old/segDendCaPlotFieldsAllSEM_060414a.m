function varargout = segDendCaPlotFieldsAllSEM_060414a(varargin)
% SEGDENDCAPLOTFIELDSALLSEM_060414A MATLAB code for segDendCaPlotFieldsAllSEM_060414a.fig
%      SEGDENDCAPLOTFIELDSALLSEM_060414A, by itself, creates a new SEGDENDCAPLOTFIELDSALLSEM_060414A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTFIELDSALLSEM_060414A returns the handle to a new SEGDENDCAPLOTFIELDSALLSEM_060414A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTFIELDSALLSEM_060414A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTFIELDSALLSEM_060414A.M with the given input arguments.
%
%      SEGDENDCAPLOTFIELDSALLSEM_060414A('Property','Value',...) creates a new SEGDENDCAPLOTFIELDSALLSEM_060414A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotFieldsAllSEM_060414a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotFieldsAllSEM_060414a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotFieldsAllSEM_060414a

% Last Modified by GUIDE v2.5 04-Jun-2014 16:08:22

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotFieldsAllSEM_060414a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotFieldsAllSEM_060414a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotFieldsAllSEM_060414a is made visible.
function segDendCaPlotFieldsAllSEM_060414a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotFieldsAllSEM_060414a (see VARARGIN)

% Choose default command line output for segDendCaPlotFieldsAllSEM_060414a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes segDendCaPlotFieldsAllSEM_060414a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotFieldsAllSEM_060414a_OutputFcn(hObject, eventdata, handles) 

function varargout = dendCaPlotEventHist_071014a(varargin)
% DENDCAPLOTEVENTHIST_071014A MATLAB code for dendCaPlotEventHist_071014a.fig
%      DENDCAPLOTEVENTHIST_071014A, by itself, creates a new DENDCAPLOTEVENTHIST_071014A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTEVENTHIST_071014A returns the handle to a new DENDCAPLOTEVENTHIST_071014A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTEVENTHIST_071014A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTEVENTHIST_071014A.M with the given input arguments.
%
%      DENDCAPLOTEVENTHIST_071014A('Property','Value',...) creates a new DENDCAPLOTEVENTHIST_071014A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotEventHist_071014a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotEventHist_071014a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotEventHist_071014a

% Last Modified by GUIDE v2.5 10-Jul-2014 15:11:27

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotEventHist_071014a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotEventHist_071014a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before dendCaPlotEventHist_071014a is made visible.
function dendCaPlotEventHist_071014a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotEventHist_071014a (see VARARGIN)

% Choose default command line output for dendCaPlotEventHist_071014a
...
% UIWAIT makes dendCaPlotEventHist_071014a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotEventHist_071014a_OutputFcn(hObject, eventdata, handles) 

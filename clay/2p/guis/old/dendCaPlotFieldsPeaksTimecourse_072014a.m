function varargout = dendCaPlotFieldsPeaksTimecourse_072014a(varargin)
% DENDCAPLOTFIELDSPEAKSTIMECOURSE_072014A MATLAB code for dendCaPlotFieldsPeaksTimecourse_072014a.fig
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_072014A, by itself, creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_072014A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSTIMECOURSE_072014A returns the handle to a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_072014A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_072014A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSTIMECOURSE_072014A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_072014A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_072014A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksTimecourse_072014a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksTimecourse_072014a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksTimecourse_072014a

% Last Modified by GUIDE v2.5 20-Jul-2014 20:14:09

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksTimecourse_072014a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksTimecourse_072014a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksTimecourse_072014a is made visible.
function dendCaPlotFieldsPeaksTimecourse_072014a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksTimecourse_072014a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksTimecourse_072014a
...
% UIWAIT makes dendCaPlotFieldsPeaksTimecourse_072014a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksTimecourse_072014a_OutputFcn(hObject, eventdata, handles) 
...
caData1bAvg = mean(caData1b,2);
caData2bAvg = mean(caData2b,2);

function varargout = segDendCaPlotFields_121413a(varargin)
% SEGDENDCAPLOTFIELDS_121413A MATLAB code for segDendCaPlotFields_121413a.fig
%      SEGDENDCAPLOTFIELDS_121413A, by itself, creates a new SEGDENDCAPLOTFIELDS_121413A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTFIELDS_121413A returns the handle to a new SEGDENDCAPLOTFIELDS_121413A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTFIELDS_121413A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTFIELDS_121413A.M with the given input arguments.
%
%      SEGDENDCAPLOTFIELDS_121413A('Property','Value',...) creates a new SEGDENDCAPLOTFIELDS_121413A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotFields_121413a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotFields_121413a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotFields_121413a

% Last Modified by GUIDE v2.5 14-Dec-2013 17:30:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotFields_121413a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotFields_121413a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotFields_121413a is made visible.
function segDendCaPlotFields_121413a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotFields_121413a (see VARARGIN)

% Choose default command line output for segDendCaPlotFields_121413a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes segDendCaPlotFields_121413a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotFields_121413a_OutputFcn(hObject, eventdata, handles) 

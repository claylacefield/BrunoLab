function varargout = segDendCaPlotFields_010914c(varargin)
% SEGDENDCAPLOTFIELDS_010914C MATLAB code for segDendCaPlotFields_010914c.fig
%      SEGDENDCAPLOTFIELDS_010914C, by itself, creates a new SEGDENDCAPLOTFIELDS_010914C or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTFIELDS_010914C returns the handle to a new SEGDENDCAPLOTFIELDS_010914C or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTFIELDS_010914C('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTFIELDS_010914C.M with the given input arguments.
%
%      SEGDENDCAPLOTFIELDS_010914C('Property','Value',...) creates a new SEGDENDCAPLOTFIELDS_010914C or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotFields_010914c_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotFields_010914c_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotFields_010914c

% Last Modified by GUIDE v2.5 09-Jan-2014 22:52:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @segDendCaPlotFields_010914c_OpeningFcn, ...
    'gui_OutputFcn',  @segDendCaPlotFields_010914c_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotFields_010914c is made visible.
function segDendCaPlotFields_010914c_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotFields_010914c (see VARARGIN)

% Choose default command line output for segDendCaPlotFields_010914c
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes segDendCaPlotFields_010914c wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotFields_010914c_OutputFcn(hObject, eventdata, handles)

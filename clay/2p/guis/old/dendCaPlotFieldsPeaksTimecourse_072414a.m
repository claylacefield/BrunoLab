function varargout = dendCaPlotFieldsPeaksTimecourse_072414a(varargin)
% DENDCAPLOTFIELDSPEAKSTIMECOURSE_072414A MATLAB code for dendCaPlotFieldsPeaksTimecourse_072414a.fig
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_072414A, by itself, creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_072414A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSTIMECOURSE_072414A returns the handle to a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_072414A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_072414A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSTIMECOURSE_072414A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_072414A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_072414A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksTimecourse_072414a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksTimecourse_072414a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksTimecourse_072414a

% Last Modified by GUIDE v2.5 25-Jul-2014 17:10:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksTimecourse_072414a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksTimecourse_072414a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksTimecourse_072414a is made visible.
function dendCaPlotFieldsPeaksTimecourse_072414a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksTimecourse_072414a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksTimecourse_072414a
...
% UIWAIT makes dendCaPlotFieldsPeaksTimecourse_072414a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksTimecourse_072414a_OutputFcn(hObject, eventdata, handles) 

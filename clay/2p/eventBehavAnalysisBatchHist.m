...
%                         end
                        ...
                        if ~isempty(rowInd) && isempty(strfind(dataFileArray{rowInd, 8}, 'stage'))
...
%                                             end
                                            ...
                                            if hz == 2
                                                ...
                                                %                                 end
                                                try
                                                    batchEventHistStruc2hz.(eventNameEventHist) = [batchEventHistStruc2hz.(eventNameEventHist) eventEventHist];
                                                catch
                                                    batchEventHistStruc2hz.(eventNameEventHist) = eventEventHist;
                                                end
                                            ...
                                            elseif hz == 4
                                                ...
                                                try
                                                    batchEventHistStruc4hz.(eventNameEventHist) = [batchEventHistStruc4hz.(eventNameEventHist) eventEventHist];
                                                catch
                                                    batchEventHistStruc4hz.(eventNameEventHist) = eventEventHist;
                                                end
                                            ...
                                            elseif hz == 8
                                                ...
                                                try
                                                    batchEventHistStruc8hz.(eventNameEventHist) = [batchEventHistStruc8hz.(eventNameEventHist) eventEventHist];
                                                catch
                                                    batchEventHistStruc8hz.(eventNameEventHist) = eventEventHist;
                                                end

function  [unitEventRateCompilStruc] = unitEventRateCompilMouse(dataFileArray)

% USAGE: [unitEventRateCompilStruc] = unitEventRateCompilMouse(dataFileArray);
            ...
            if dayDir(b).isdir
                ...
                if rowInd
                    ...
                    if isempty(strfind(dataFileArray{rowInd, 8}, 'stage'))
                        ...
                        [maxSegDatenum, maxSegInd] = max(tifDatenums(segFileInd));
                        ...
                        for numSeg = 1:length(goodSeg)
                            ...
                            unitRewEpochMat(:,totalNumSeg) = ((rewRoiHist/numRewTrials) - roiPkRateSeg)/roiPkRateSeg;
                            unitUnrewEpochMat(:,totalNumSeg) = ((unrewRoiHist/numUnrewTrials) - roiPkRateSeg)/roiPkRateSeg;
...
unitEventRateCompilStruc.unitRewEpochMat = unitRewEpochMat;
%unitEventRateCompilStruc.unitRewEpochArr2 = unitRewEpochArr2;
unitEventRateCompilStruc.unitUnrewEpochMat = unitUnrewEpochMat;
%unitEventRateCompilStruc.unitUnrewEpochArr2 = unitUnrewEpochArr2;

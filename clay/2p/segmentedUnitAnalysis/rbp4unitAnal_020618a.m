function [rbp4unitEpochStruc] = rbp4unitAnal_012418a()
...
for i = 1:length(rbp4unitEpochStruc)
    ...
    rbp4unitEpochStruc(i).rew4trackStruc.rew4units = rew4unInd;
    catch
    ...
    rbp4unitEpochStruc(i).rew4trackStruc.randRewUnits = randRewUnitInd;
    %rbp4unitEpochStruc(i).rew4trackStruc.
    rbp4unitEpochStruc(i).rew4trackStruc.rewTrackUnits = unitRewTrackStruc.rewTrackUnits;
    rbp4unitEpochStruc(i).rew4trackStruc.bothRewUnitInd = intersect(randRewUnitInd, unitRewTrackStruc.rewTrackUnits);
...
%     end
    ...
    try
        ...
        rbp4unitEpochStruc(i).segStruc.rewDelay1TimeCa = segStruc.rewDelay1TimeCa(:, goodSeg, :);
        rbp4unitEpochStruc(i).segStruc.rewDelay1TimeRoiHist = segStruc.rewDelay1TimeRoiHist(:, goodSeg);
        rbp4unitEpochStruc(i).segStruc.rewDelay1TimeRoiHist2 = segStruc.rewDelay1TimeRoiHist2(:, goodSeg);
        
        rbp4unitEpochStruc(i).segStruc.rewDelay2TimeCa = segStruc.rewDelay2TimeCa(:, goodSeg, :);
        rbp4unitEpochStruc(i).segStruc.rewDelay2TimeRoiHist = segStruc.rewDelay2TimeRoiHist(:, goodSeg);
        rbp4unitEpochStruc(i).segStruc.rewDelay2TimeRoiHist2 = segStruc.rewDelay2TimeRoiHist2(:, goodSeg);
        
        rbp4unitEpochStruc(i).segStruc.rewDelay3TimeCa = segStruc.rewDelay3TimeCa(:, goodSeg, :);
        rbp4unitEpochStruc(i).segStruc.rewDelay3TimeRoiHist = segStruc.rewDelay3TimeRoiHist(:, goodSeg);
        rbp4unitEpochStruc(i).segStruc.rewDelay3TimeRoiHist2 = segStruc.rewDelay3TimeRoiHist2(:, goodSeg);
        
    catch
        disp('Problem processing rewDelayCa (prob none present');
    end

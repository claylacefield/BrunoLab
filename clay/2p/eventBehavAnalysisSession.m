function [dendriteBehavStruc] = eventBehavAnalysisSession() % tifName, dayPath, seg, toProcess)

% Clay Mar. 2017
% This function performs the current eventBehavAnalysis within a session
% folder. This is from dendriteBehavAnalysisSessions on about 050517.
% It should do these things:
%  - whiskSig averaged on behav
%  - whiskContacts averaged on behav
%  - licks
% To do this:
% 1.) load in signals
% 2.) detect behav events
...
currPath = pwd;
dayPath = currPath(1:(end-15));
tifBasename = currPath(end-13:end);

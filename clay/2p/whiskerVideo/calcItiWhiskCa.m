function [whiskBoutCaStruc] = calcItiWhiskCa(itiInds, timeMs, wPkTimes, dendriteBehavStruc, v, ma, params)
...
itiBegTimes = itiBegTimes(itiInds);
itiEndTimes = itiEndTimes(itiInds);

for trial = 1:length(itiInds)
    %disp(trial);
...
whiskBoutCaStruc.itiWhiskPkTimes = whiskAirPks;
whiskBoutCaStruc.itiWhiskZeroFrames = zeroFrame;

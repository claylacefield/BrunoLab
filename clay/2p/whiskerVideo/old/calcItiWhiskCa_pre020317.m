function [whiskBoutCaStruc] = calcItiWhiskCa(stimTrigTime, timeMs, wPkTimes, dendriteBehavStruc, v, ma)
...
for trial = 1:length(stimTrigTime)
    whiskAirPks = [whiskAirPks wPkTimes((wPkTimes<(stimTrigTime(trial)-1000)) & (wPkTimes>(stimTrigTime(trial)-2000)))];
end
%disp(whiskAirPks);

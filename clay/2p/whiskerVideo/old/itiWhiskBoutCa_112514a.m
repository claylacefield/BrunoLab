function [eventCa] = itiWhiskBoutCa(dendriteBehavStruc, x2, mean_angle, time)
...
v=v';
sv = std(v);
wPks = LocalMinima(-v, 300, -sv); % detect peaks
...
whiskAirPks = [whiskAirPks wPkTimes((wPkTimes<cleanStimTrigTime(trial)) & (wPkTimes>(cleanStimTrigTime(trial)-3000)))];
end

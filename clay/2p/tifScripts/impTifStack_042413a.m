function [frameAvgDf1, frameAvgDf2, caRefCorr, diffCorr] = impTifStack(numImCh)
...
if numImCh ==2 
    ...
    caRefCorr = xcorr(frameAvgDf1, frameAvgDf2, 40);    % xcorr of Ca and reflected IR
    
    d1 = diff(frameAvgDf1);
    d2 = diff(frameAvgDf2);
    
    diffCorr = xcorr(d1,d2, 10);    % now take xcorr of diff

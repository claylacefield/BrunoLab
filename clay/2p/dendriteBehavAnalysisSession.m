function [dendriteBehavStruc] = dendriteBehavAnalysisSession() % tifName, dayPath, seg, toProcess)

% Clay Mar. 2017
% This function performs the current dendriteBehavAnalysis within a session
% folder

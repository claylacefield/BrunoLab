function [eventStruc, x2] = detect2pEventsSingle(tifDatenum, fps)
...
[correctRespStruc] = correctResp2pSingle(tifDatenum);
...
[frameTrig] = detectGalvoFrames(galvoSig, fps);  % 150717 now broke this out to function

function [dendriteBehavStruc] = dendriteBehavAnalysis() % nChannels, fps, avg, roi)
...
for field = 1:length(fieldNames)
    ...
    if ~isempty(eventStruc.(fieldNames{field}))
        ...
        if isempty(strfind(fieldNames{field}, 'Trig')) && isempty(strfind(fieldNames{field}, 'licks'))
...
save([fn '_dendriteBehavStruc'], 'dendriteBehavStruc');

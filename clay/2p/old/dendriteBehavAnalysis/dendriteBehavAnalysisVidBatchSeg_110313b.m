function  dendriteBehavAnalysisVidBatchSeg(dataFileArray, seg)
...
for mouse = 3:length(cageDir)
                    ...
                    if dayDir(b).isdir
                        ...
                        if rowInd
                            ...
                            if strfind(dataFileArray{rowInd, 8}, 'stage')
                                ...
                                [eventStruc] = detect2pEventsVidBatch(dataFileArray, rowInd);  % detect2pEvents(nChannels, sf);
    ...
    end % END if cageDir(mouse).isdir
end     % END FOR mouse = 3:length(cageDir)

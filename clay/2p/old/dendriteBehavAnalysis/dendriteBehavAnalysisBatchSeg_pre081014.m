                            ...
                            if ~isempty(C)
                                ...
                                for roiNum = 1:size(C,2)
                                    ...
                                    try
                                        ...
                                        roiSd = std(roiDf);
                                        roiPkInd = LocalMinima(-roiDf, 3, -1*roiSd);   % indices of Ca2+ pks
...
%                             if ~exist('rewStimTif.tif')
                                for fr = 1:size(rewStimTifAvg, 3)
                                    imwrite(rewStimTifAvg(:,:,fr), [fn '_rewStimTif.tif'], 'writemode', 'append');
                                    imwrite(unrewStimTifAvg(:,:,fr), [fn '_unrewStimTif.tif'], 'writemode', 'append');
                                end
%                             end

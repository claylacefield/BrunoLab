function  whiskerBehavAnalysisBatchSeg(dataFileArray, seg)
...
%                 end
                ...
                preFrame = 2*1000;    % number of frames to take before and after event time
                postFrame = 6*1000;
...
%                             eventTimes = eventTimes(eventTimes > (2001) & eventTimes < (whiskSig1(end)-6001));
%                             

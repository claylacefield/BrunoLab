...
rewardsCaAvg = batchDendStruc2hz.rewardsCaAvg;
punTimeCaAvg = batchDendStruc2hz.punTimeCaAvg;
corrRewIndCaAvg = batchDendStruc2hz.corrRewIndCaAvg;
incorrRewIndCaAvg = batchDendStruc2hz.incorrRewIndCaAvg;
corrUnrewIndCaAvg = batchDendStruc2hz.corrUnrewIndCaAvg;
incorrUnrewIndCaAvg = batchDendStruc2hz.incorrUnrewIndCaAvg;
corrFirstContactTimesCaAvg = batchDendStruc2hz.corrFirstContactTimesCaAvg;
incorrFirstContactTimesCaAvg = batchDendStruc2hz.incorrFirstContactTimesCaAvg;

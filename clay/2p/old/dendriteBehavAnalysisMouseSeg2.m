function  dendriteBehavAnalysisMouseSeg2(dataFileArray, seg, saveTif)
                    ...
                    if ~isempty(C)
                        ...
                        for roiNum = 1:size(C,2)
                            ...
                            try
                                ...
                                roiThresh = 2*std(roiDf);
                                
                                roiPkInd = LocalMinima(-roiDf, fps, -roiThresh);   % indices of Ca2+ pks
                                ...
                                roiPkInd2 = threshold(diffRoiDf, droiSd, fps);   % indices of Ca2+ pks

function  dendriteBehavAnalysisMouse(dataFileArray, seg, saveTif)
...
%                                 end
                            ...
                            if seg == 1
                                ...
                                disp(['loading in first segmented file: ' tifDir(latestSegInd).name]);
                                    ...
                                    if (~isempty(strfind(fieldNames{field}, 'StimInd')) || ~isempty(strfind(fieldNames{field}, 'Time')))
                                        ...
                                        try
                                            ...
                                            if ~isempty(C)
                                                ...
                                                [zeroFrame, eventCa , eventCaAvg] = eventTrigCa(filename, eventStruc, hz, frameAvgDf, field, tifStack2);

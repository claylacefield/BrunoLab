...
for eventNum = 1:(length(rewPunStimTime)-1)
   isoLickTime = [isoLickTime; licks(licks > (rewPunStimTime(eventNum)+2000) & licks < (rewPunStimTime(eventNum+1)-2000))]; 
...
for eventNum = 1:(length(rewPunStimTime)-1)
   isoLevLiftTime = [isoLevLiftTime; levLift(levLift > (rewPunStimTime(eventNum)+2000) & levLift < (rewPunStimTime(eventNum+1)-2000))]; 

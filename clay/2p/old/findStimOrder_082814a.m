function [stimOrderStruc] = findStimOrder(eventStruc)
...
stimOrderStruc.order1rewStimInd = intersect(order1StimInd, rewStimStimInd);
stimOrderStruc.order2rewStimInd = intersect(order2StimInd, rewStimStimInd);
stimOrderStruc.order3rewStimInd = intersect(order3StimInd, rewStimStimInd);

stimOrderStruc.order1unrewStimInd = intersect(order1StimInd, unrewStimStimInd);
stimOrderStruc.order2unrewStimInd = intersect(order2StimInd, unrewStimStimInd);
stimOrderStruc.order3unrewStimInd = intersect(order3StimInd, unrewStimStimInd);
...
stimOrderStruc.firstRewAfter1unrewStimInd = intersect(firstAfter1StimInd, rewStimStimInd);
stimOrderStruc.firstRewAfter2unrewStimInd = intersect(firstAfter2StimInd, rewStimStimInd);
stimOrderStruc.firstRewAfter3unrewStimInd = intersect(firstAfter3StimInd, rewStimStimInd);

stimOrderStruc.firstUnrewAfter1rewStimInd = intersect(firstAfter1StimInd, unrewStimStimInd);
stimOrderStruc.firstUnrewAfter2rewStimInd = intersect(firstAfter2StimInd, unrewStimStimInd);
stimOrderStruc.firstUnrewAfter3rewStimInd = intersect(firstAfter3StimInd, unrewStimStimInd);

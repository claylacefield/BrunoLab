function [dendriteBehavStruc, segStruc, roiAvgDf, frameAvgDf, eventStruc, x2] = dendriteBehavAnalysisSingleSegROI(fps) % nChannels, fps, avg, roi)
...
%     end
    ...
    C(:,roiNum) =  (roiCaAdj - roiAvg)./roiAvg;
end

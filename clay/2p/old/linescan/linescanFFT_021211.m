function [pkOffset, pkOnset, pkGam, meanPixVal, powspec, f, gamSum, delF, yMat, spatMeanMat, filepath] = linescanFFT();
...
for i=1:400
    ...
    pkOnset(i) = min(delF(70:120))/std(spatMean(30:60));
    pkOffset(i) = min(delF(175:225))/std(spatMean(30:60));

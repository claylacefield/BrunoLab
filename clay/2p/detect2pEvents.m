function [eventStruc, x2] = detect2pEvents(fps) %(nChannels, fps, sf)
...
eventStruc.rewTime1 = rew(rewInd1);
eventStruc.rewTime2 = rew(rewInd2);
eventStruc.rewTime3 = rew(rewInd3);
eventStruc.rewTime4 = rew(rewInd4);

eventStruc.rewArr = rewArr;
...
frameTrig = LocalMinima(galvoSig, frameTimeout, -0.3);
...
eventStruc.punTime1 = punTime(punInd1);
eventStruc.punTime2 = punTime(punInd2);

eventStruc.punArr = punArr;

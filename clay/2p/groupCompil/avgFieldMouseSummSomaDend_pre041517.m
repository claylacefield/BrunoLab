function  [mouseValSoma, mouseValDend] = avgFieldMouseSummSomaDend(mouseSummCell, varargin)
...
if length(varargin) == 4
    ...
    avgColTag = varargin{3};    % which column to compute averages for (e.g. 'corrRewStimIndCa', 'fullSessionXcorr')
...
somaRows = find(not(cellfun('isempty', strfind(mouseSummCell(:,somaDendColNum), 's'))));

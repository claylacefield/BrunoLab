function out = imaqTest_093010a
%IMAQTEST_093010A M-Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This M-file, IMAQTEST_093010A.M, was generated from the OBJ2MFILE function.
...
%   type the name of the M-file, imaqTest_093010a, at the MATLAB command prompt.
%   
%   The M-file, IMAQTEST_093010A.M and its associated MAT-file, IMAQTEST_093010A.MAT (if
%   it exists) must be on your MATLAB path.
%   
%   Example: 
%       vidobj = imaqTest_093010a;
%   
...
try
    MATvar = load('C:\Documents and Settings\lab\My Documents\MATLAB\clay\imaqTest_093010a');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in C:\Documents and Settings\lab\My Documents\MATLAB\clay\imaqTest_093010a.mat.
if (MATLoaded)

...
%% USAGE: [cageBatchStruc] = cageBatchAvg(batchStruc, numSessions, toPlot)
...
for mouse = 3:length(cageDir)
    ...
    if cageDir(mouse).isdir
        ...
        batchFileInd = find(strncmp(mouseDirName, batchStruc, length(batchStruc))); 
...
%         end
        ...
        for field = 1:length(fieldNames)
            ...
            try
                ...
                eventAvg = nanmean(eventDays, 2);  % and take the average for these

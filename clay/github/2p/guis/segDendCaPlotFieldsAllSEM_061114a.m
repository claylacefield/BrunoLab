function varargout = segDendCaPlotFieldsAllSEM_061114a(varargin)
% SEGDENDCAPLOTFIELDSALLSEM_061114A MATLAB code for segDendCaPlotFieldsAllSEM_061114a.fig
%      SEGDENDCAPLOTFIELDSALLSEM_061114A, by itself, creates a new SEGDENDCAPLOTFIELDSALLSEM_061114A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTFIELDSALLSEM_061114A returns the handle to a new SEGDENDCAPLOTFIELDSALLSEM_061114A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTFIELDSALLSEM_061114A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTFIELDSALLSEM_061114A.M with the given input arguments.
%
%      SEGDENDCAPLOTFIELDSALLSEM_061114A('Property','Value',...) creates a new SEGDENDCAPLOTFIELDSALLSEM_061114A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotFieldsAllSEM_061114a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotFieldsAllSEM_061114a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotFieldsAllSEM_061114a

% Last Modified by GUIDE v2.5 11-Jun-2014 16:40:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotFieldsAllSEM_061114a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotFieldsAllSEM_061114a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotFieldsAllSEM_061114a is made visible.
function segDendCaPlotFieldsAllSEM_061114a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotFieldsAllSEM_061114a (see VARARGIN)

% Choose default command line output for segDendCaPlotFieldsAllSEM_061114a
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes segDendCaPlotFieldsAllSEM_061114a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotFieldsAllSEM_061114a_OutputFcn(hObject, eventdata, handles) 

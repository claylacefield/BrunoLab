function varargout = segDendCaPlotHistAll_010616a(varargin)
% SEGDENDCAPLOTHISTALL_010616A MATLAB code for segDendCaPlotHistAll_010616a.fig
%      SEGDENDCAPLOTHISTALL_010616A, by itself, creates a new SEGDENDCAPLOTHISTALL_010616A or raises the existing
%      singleton*.
%
%      H = SEGDENDCAPLOTHISTALL_010616A returns the handle to a new SEGDENDCAPLOTHISTALL_010616A or the handle to
%      the existing singleton*.
%
%      SEGDENDCAPLOTHISTALL_010616A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGDENDCAPLOTHISTALL_010616A.M with the given input arguments.
%
%      SEGDENDCAPLOTHISTALL_010616A('Property','Value',...) creates a new SEGDENDCAPLOTHISTALL_010616A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segDendCaPlotHistAll_010616a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segDendCaPlotHistAll_010616a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segDendCaPlotHistAll_010616a

% Last Modified by GUIDE v2.5 06-Jan-2016 19:23:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segDendCaPlotHistAll_010616a_OpeningFcn, ...
                   'gui_OutputFcn',  @segDendCaPlotHistAll_010616a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segDendCaPlotHistAll_010616a is made visible.
function segDendCaPlotHistAll_010616a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to segDendCaPlotHistAll_010616a (see VARARGIN)

% Choose default command line output for segDendCaPlotHistAll_010616a
...
% UIWAIT makes segDendCaPlotHistAll_010616a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = segDendCaPlotHistAll_010616a_OutputFcn(hObject, eventdata, handles) 

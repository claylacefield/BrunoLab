function varargout = dendCaPlotFieldsPeaksTimecourse_050715a(varargin)
% DENDCAPLOTFIELDSPEAKSTIMECOURSE_050715A MATLAB code for dendCaPlotFieldsPeaksTimecourse_050715a.fig
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_050715A, by itself, creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_050715A or raises the existing
%      singleton*.
%
%      H = DENDCAPLOTFIELDSPEAKSTIMECOURSE_050715A returns the handle to a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_050715A or the handle to
%      the existing singleton*.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_050715A('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DENDCAPLOTFIELDSPEAKSTIMECOURSE_050715A.M with the given input arguments.
%
%      DENDCAPLOTFIELDSPEAKSTIMECOURSE_050715A('Property','Value',...) creates a new DENDCAPLOTFIELDSPEAKSTIMECOURSE_050715A or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before dendCaPlotFieldsPeaksTimecourse_050715a_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to dendCaPlotFieldsPeaksTimecourse_050715a_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help dendCaPlotFieldsPeaksTimecourse_050715a

% Last Modified by GUIDE v2.5 07-May-2015 18:53:33

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @dendCaPlotFieldsPeaksTimecourse_050715a_OpeningFcn, ...
                   'gui_OutputFcn',  @dendCaPlotFieldsPeaksTimecourse_050715a_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before dendCaPlotFieldsPeaksTimecourse_050715a is made visible.
function dendCaPlotFieldsPeaksTimecourse_050715a_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to dendCaPlotFieldsPeaksTimecourse_050715a (see VARARGIN)

% Choose default command line output for dendCaPlotFieldsPeaksTimecourse_050715a
...
% UIWAIT makes dendCaPlotFieldsPeaksTimecourse_050715a wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = dendCaPlotFieldsPeaksTimecourse_050715a_OutputFcn(hObject, eventdata, handles) 

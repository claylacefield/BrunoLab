function [segStruc] = nmfSmoothSingle3(K,beta, plotSeg, toSmooth, toSave)
...
disp(['Importing TIF stack for ' filename]); tic;
...
save([basename '_seg_' num2str(toSave) '_' date], 'segStruc');

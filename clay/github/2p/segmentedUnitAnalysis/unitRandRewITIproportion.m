...
% 071117: changing method to find stim/iti epochs
...
[itiStruc, eventStruc] = findStimITIind(dendriteBehavStruc.eventStruc);
unitItiPropStruc.itiStruc = itiStruc;

% load in times of randRew and ITIs
rewTime4 = dendriteBehavStruc.eventStruc.rewTime4;
itiBegTime3 = itiStruc.itiBegTimes; %itiBegInd;
itiEndTime3 = itiStruc.itiEndTimes; %itiEndInd;

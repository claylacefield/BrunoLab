function [spatDiscStruc] = spatDisc2p_b();
...
%%
        ...
        try
            spatDiscStruc(numRec).name = filepath;
        catch
        end
        try
        ...
        try
            spatDiscStruc(numRec).stimType = stimType;
        catch
        end

%%
        clear levPress stim rewStim unrewStim reward levTime noStimLev unrewLev stimType;

...
[spatDiscStruc] = spatDisc2p_b();
stimType = spatDiscStruc.stimType;

rewStimInd = find(stimType == 2);
unrewStimInd = find(stimType == 1);
...
figure; plot(avRewStimPlot); hold on; plot(avUnrewStimPlot, 'r');
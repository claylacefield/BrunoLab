function [spatDiscStruc, spatDiscGrpStruc, names] = spatDiscGrp(day,bin)
...
%% RUN SPATDISC FUNCTION
%MAKE SURE SAVE LOCATION IN SPATDISC FUNCTION IS CORRECT
spatDiscStruc = spatDisc(day);


%% START PROGRAM
% initialize variables

minBin = bin;  % time base over which to calculate histograms

...
for i = 30:length(currDir);
    ...
    if strfind(currDir(i).name, '.txt');    % make sure file is .txt, thus data
        ...
        clear correctRewStimTime correctStimTime corrLevPressLatency incorrectRewStimTime incorrectStimTime incorrectUnrewStimTime incorrLevPressLatency correctUnrewStimTime stimTypeArr corrRespArr;

function LogisticAnalysis(x, y, grid, xlab, ylab, plotcodes)

% LOGISTICANALYSIS(x, y, grid, xlab, ylab, plotcodes) For binary Y response,
...
% grid: binsize for histograms of response variable. Unfortunately,
%       Matlab's glmfit function requires binning.
...
p = success./total;
scatter(bins, p);
[b, dev, stats] = glmfit(bins, [success total], 'binomial');

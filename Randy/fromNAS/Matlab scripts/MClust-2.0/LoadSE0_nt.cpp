...
* version 5.0
*
* Reads NT-SE (single electrode) files and returns a standard wv array where the 
* the SE data are in channel 1 and channels 2-4 are padded with zeros 
...
//___________________________________________________________________________________
void ReadSE(char* fn, int nSpikes, double *t, double *wv){

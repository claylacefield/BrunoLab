...
% Last Modified by GUIDE v2.5 30-Jan-2014 16:19:27
...
trialstart = str2double(get(handles.TrialStartField, 'String'));
trialend = str2double(get(handles.TrialEndField, 'String'));
...
function TrialStartField_Callback(hObject, eventdata, handles)
% hObject    handle to TrialStartField (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of TrialStartField as text
%        str2double(get(hObject,'String')) returns contents of TrialStartField as a double


% --- Executes during object creation, after setting all properties.
function TrialStartField_CreateFcn(hObject, eventdata, handles)
% hObject    handle to TrialStartField (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function TrialEndField_Callback(hObject, eventdata, handles)
% hObject    handle to TrialEndField (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of TrialEndField as text
%        str2double(get(hObject,'String')) returns contents of TrialEndField as a double


% --- Executes during object creation, after setting all properties.
function TrialEndField_CreateFcn(hObject, eventdata, handles)
% hObject    handle to TrialEndField (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
